...
describe('X25519 key agreement (RFC 7748 §6.1)', () => {
  // RFC 7748 §6.1
  const alicePriv = hex('77076d0a7318a57d3c16c17251b26645c6c2f6f166d46d77aed44e8c500f8f0a');
  ...
  const bobPub    = hex('de9edb7d7b7dc1b4d35b61c2ece435306accd47d9ed2a1b4a9a4d7a0c3edc6b3');
...
describe('full key-exchange flow', () => {
  ...
  it('third party cannot decrypt', () => {
    ...
    const ct = encryptDirectMessage(alice.privateKey, bob.publicKey, aliceAddr, bobAddr, 'secret', 0);
    expect(() =>
